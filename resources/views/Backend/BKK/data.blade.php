...
@section('title','Data Bursa Kerja Khsus')
                    ...
                    <div class="box">
                      <div class="box-header">
                        ...
                        <div class="pull-right">
                            <a href="{{url('admin/BKK/add')}}" class="btn btn-success">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$data->tanggal}}</td>
                                <td>
                                    <a href="{{ url('admin/BKK/edit/'.$data->id_bkk) }}" class="btn btn-warning btn-sm">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ url('admin/BKK/'.$data->id_bkk) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin Hapus Data')">
                                        @method('delete')
                                        @csrf
