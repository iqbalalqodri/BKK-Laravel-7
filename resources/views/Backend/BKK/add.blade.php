...
@section('title','Bursah Kerja Khusus Add')
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                  <div class="box-header with-border">
                    <h3 class="box-title">Add Bursah Kerja Khusus</h3>
                  </div>
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form class="form-horizontal"  action="{{url('admin/BKK')}}" method="post"enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
