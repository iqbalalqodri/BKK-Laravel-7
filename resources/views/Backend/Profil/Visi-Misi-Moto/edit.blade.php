...
@section('title','Profil Visi Misi Moto Edit')
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal"  action="{{url('admin/Profil-Visi-Misi-Moto/'.$Profil->id)}}" method="post" >
            @method('PATCH')
            {{ csrf_field() }}
            ...
            <div class="box-footer">
              <a class="btn btn-default" href="{{url('admin/Profil-Visi-Misi-Moto')}}">cancel</a>
