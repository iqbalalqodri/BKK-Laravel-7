  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal"  action="{{url('admin/Profil-Dasar-Pemikiran/'.$Profil->id)}}" method="post" >
            @method('PATCH')
            {{ csrf_field() }}
            ...
            <div class="box-footer">
              <a class="btn btn-default" href="{{url('admin/Profil-Dasar-Pemikiran')}}">cancel</a>
